...
public:
    ...
    void setupUi(QWidget *qqContact)
    {
        ...
        friends->setGeometry(QRect(9, 9, 311, 192));
        ...
        listWidget->setGeometry(QRect(9, 242, 311, 192));
        lineEdit = new QLineEdit(qqContact);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));
        lineEdit->setGeometry(QRect(271, 475, 58, 25));
        jiaqun = new QLineEdit(qqContact);
        jiaqun->setObjectName(QString::fromUtf8("jiaqun"));
        jiaqun->setGeometry(QRect(210, 570, 91, 21));
        ...
        add_group->setGeometry(QRect(210, 620, 89, 25));
